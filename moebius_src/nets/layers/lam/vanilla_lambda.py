...
# NOTE(vendored): upstream set torch._dynamo.config.suppress_errors = True here,
# a process-wide side effect removed for ComfyUI (it would mask dynamo errors globally).
